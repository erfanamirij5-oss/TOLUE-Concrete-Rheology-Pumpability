...
const REPORT_TEXT_FA: Record<string,string> = {
  ...
  'Project-qualified evidence is acceptable for the supplied domains.':'شواهد واجد شرایط پروژه در دامنه‌های ارائه‌شده قابل قبول است.',
  ...
  'Stability and blockage conclusions identify whether they arise from project-qualified evidence or preliminary engineering screening; neither is a universal physical prediction.':'نتایج پایداری و انسداد مشخص می‌کنند که مبنا شواهد معتبر پروژه‌ای است یا غربالگری مهندسی مقدماتی؛ هیچ‌یک پیش‌بینی فیزیکی عمومی برای همه شرایط محسوب نمی‌شود.',
