...
const m = vi.hoisted(() => ({
  ...
  on: vi.fn(), once: vi.fn(), open: vi.fn(), registerPdf: vi.fn(), registerAnalysis: vi.fn(), registerRunLoad: vi.fn(), registerLicense: vi.fn(), disposePdf: vi.fn(), disposeAnalysis: vi.fn(), disposeRunLoad: vi.fn(), disposeLicense: vi.fn(),
...
beforeEach(() => {
  ...
  m.load.mockResolvedValue(undefined); m.registerPdf.mockReturnValue(m.disposePdf); m.registerAnalysis.mockReturnValue(m.disposeAnalysis); m.registerRunLoad.mockReturnValue(m.disposeRunLoad); m.registerLicense.mockReturnValue(m.disposeLicense);
});
