...
export function createEngineeringViewportKpis(
  ...
  return Object.freeze([
    ...
    Object.freeze({ id:'pressure-margin', label:'حاشیه فشار', value:pressure(margin), detail:live?'فشار قابل تأمین − فشار موردنیاز':'پس از اجرای تحلیل', tone:margin === null?'neutral':margin >= 0?'nominal':'critical', source:margin === null?'unavailable':'engineering-core' }),
  ]);
}
