...
export function userFacingEngineeringTextFa(value:string):string{
  const exact:Record<string,string>={
    ...
    'Review suspending-phase rheology, aggregate size/density, mixture stability measurements, and project-qualified evidence before pumping.':'پیش از پمپاژ، رئولوژی فاز معلق‌کننده، اندازه و چگالی سنگدانه، آزمون‌های پایداری مخلوط و شواهد معتبر پروژه‌ای را بازبینی کنید.',
