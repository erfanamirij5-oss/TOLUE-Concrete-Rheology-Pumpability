...
export const PROJECT_METADATA_FIELDS: readonly { field: ProjectMetadataField; label: string; placeholder: string; maxLength: number; required?: boolean }[] = Object.freeze([
